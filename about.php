    ...
    <div class="card-body">
      ...
      <div class="container text-center">
        <div class="row">
          ...
          <div class="col">
            Thank you for your interest in Cafe Coffee Day. We are glad to expand our existing (Company owned or company
            operated) cafes. However, We do NOT franchise.We would be glad to partner with you, if you own a commercial
            or commercially converted/convertible retail space on a rental/revenue share basis with the following
            specifications:
            1) Retail Space Area: 1000 - 1500Sqft (Ground Floor)
            2) Minimum Frontage: 25 running feet
            3) Ample Parking space
            If you meet our specifications mentioned above, please write to us with the following (mandatory) details
